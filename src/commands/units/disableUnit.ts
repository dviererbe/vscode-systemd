...
export async function disableUnit(context: IActionContext, unitTreeItem: UnitTreeItem): Promise<void>
{
    context.errorHandling.suppressDisplay = false;
    const unit = unitTreeItem.item;
    await SystemctlCommand.disable(context, { scope: unit.scope, runtime: false, unit: unit.unitFileName });
}
