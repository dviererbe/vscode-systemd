...
export async function enableUnitUntilRestart(context: IActionContext, unitTreeItem: UnitTreeItem): Promise<void>
{
    context.errorHandling.suppressDisplay = false;
    const unit = unitTreeItem.item;
    await SystemctlCommand.enable(context, { scope: unit.scope, runtime: false, unit: unit.unitFileName });
}
