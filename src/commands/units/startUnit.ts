...
export async function startUnit(context: IActionContext, unitTreeItem: UnitTreeItem): Promise<void>
{
    context.errorHandling.suppressDisplay = false;
    const unit = unitTreeItem.item;
    await SystemctlCommand.start(context, { scope: unit.scope, unit: unit.unitFileName });
}
