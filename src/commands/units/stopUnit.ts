...
export async function stopUnit(context: IActionContext, unitTreeItem: UnitTreeItem): Promise<void>
{
    context.errorHandling.suppressDisplay = false;
    const unit = unitTreeItem.item;
    await SystemctlCommand.stop(context, { scope: unit.scope, unit: unit.unitFileName });
}
