...
export async function restartUnit(context: IActionContext, unitTreeItem: UnitTreeItem): Promise<void>
{
    context.errorHandling.suppressDisplay = false;
    const unit = unitTreeItem.item;
    await SystemctlCommand.restart(context, { scope: unit.scope, unit: unit.unitFileName });
}
